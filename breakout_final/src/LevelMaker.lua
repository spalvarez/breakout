    ...
    if #bricks == 0 then
        ...
        for i=1,numPowerups do
            ...
            if not bricks[powerupbrick].hasPowerup then
                bricks[powerupbrick].hasPowerup = true
                p = Powerup(
                    --render at middle of brick
                    bricks[powerupbrick].x + bricks[powerupbrick].width/2 - 8,
                    --render at the brick's y
                    bricks[powerupbrick].y
                )
                bricks[powerupbrick].powerup = p
                i = i+1
            end
        end
        return bricks
