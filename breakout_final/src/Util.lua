...
--[[
    This function is specifically made to piece out the powerup icons 
    from the sprite sheet. They are confined to the 13th row of the sheet
    so we can just grab them from there.
]]
